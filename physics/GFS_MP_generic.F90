...
!> @{
      subroutine GFS_MP_generic_post_run(im, levs, kdt, nrcm, ncld, nncl, ntcw, ntrac, imp_physics, imp_physics_gfdl,     &
        ...
        totsnw, totgrp, cnvprcpb, totprcpb, toticeb, totsnwb, totgrpb, rain_cpl,rain_cplchm, rainc_cpl, snow_cpl,         & 
        snow_cplchm, pwat, drain_cpl, dsnow_cpl, lsm, lsm_ruc, lsm_noahmp, raincprv, rainncprv, iceprv, snowprv,          &
...
!
      ...
      real(kind=kind_phys), dimension(:),      intent(inout) :: rain, domr_diag, domzr_diag, domip_diag, doms_diag, tprcp,  &
                                                                ...
                                                                totprcpb, toticeb, totsnwb, totgrpb, rain_cpl, rain_cplchm, &
                                                                rainc_cpl, snow_cpl, snow_cplchm, pwat
