...
contains
  ...
  ! @{
  subroutine sfc_nst_lake_post_run                               &
       ( im, kdt, rlapse, tgice, wet, use_lake_model, icy, oro,  &
       oro_uf, nstf_name1, oceanfrac,                            &
    ...
    return
  end subroutine sfc_nst_lake_post_run

end module sfc_nst_lake_post
